...
public:
    ...
    void setupUi(QDialog *LoginDialog)
    {
        ...
        ead_label = new QLabel(head_widget);
        ead_label->setObjectName(QString::fromUtf8("ead_label"));
        ead_label->setMinimumSize(QSize(200, 200));
        ead_label->setMaximumSize(QSize(200, 200));

        gridLayout->addWidget(ead_label, 1, 0, 1, 1);
