...
public:
    ...
    void setupUi(QDialog *LoginDialog)
    {
        ...
        user_edit = new QLabel(LoginDialog);
        ...
        user_label = new QLineEdit(LoginDialog);
        ...
        forget_label->setTextFormat(Qt::AutoText);
        ...
        login_btn->setMinimumSize(QSize(80, 30));
        ...
        reg_btn->setMinimumSize(QSize(80, 30));
    ...
    void retranslateUi(QDialog *LoginDialog)
    {
        ...
        user_edit->setText(QCoreApplication::translate("LoginDialog", "\347\224\250\346\210\267\357\274\232", nullptr));
