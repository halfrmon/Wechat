...
inline void GetVarifyReq::set_email(const char* value, size_t size) {
...
inline void GetVarifyRsp::set_email(const char* value, size_t size) {
...
inline void GetVarifyRsp::set_code(const char* value, size_t size) {
